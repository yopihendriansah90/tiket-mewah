...
return [
    ...
    */
    ...
    'custom_permissions' => [
        'Access:AdminPanel' => 'Akses Admin Panel',
        'Manage:Vendors' => 'Kelola Vendor',
        'Manage:Users' => 'Kelola User',
        'Manage:Events' => 'Kelola Event',
        'View:Events' => 'Lihat Event',
        'Manage:EventSettings' => 'Kelola Pengaturan Event',
        'Manage:Gates' => 'Kelola Gate',
        'Manage:Families' => 'Kelola Keluarga',
        'Manage:FamilyMembers' => 'Kelola Anggota Keluarga',
        'Import:Families' => 'Import Data Keluarga',
        'Generate:Tickets' => 'Generate Tiket',
        'Download:Tickets' => 'Download Tiket',
        'Scan:Tickets' => 'Scan Tiket',
        'Checkin:Members' => 'Check-in Anggota',
        'Create:TicketIssues' => 'Buat Issue Tiket',
        'Use:HelperDesk' => 'Akses Helper Desk',
        'Manual:Checkin' => 'Manual Check-in',
        'Approve:Override' => 'Approve Override',
        'Reprint:Tickets' => 'Reprint Tiket',
        'Regenerate:Tickets' => 'Regenerate Tiket',
        'View:Reports' => 'Lihat Report',
        'View:AuditLogs' => 'Lihat Audit Log',
    ],
